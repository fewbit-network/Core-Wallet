...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_2_INSTANTSEND_ENABLED, 1760816885),         // ON
    MAKE_SPORK_DEF(SPORK_3_INSTANTSEND_BLOCK_FILTERING, 1760816885), // ON
    MAKE_SPORK_DEF(SPORK_9_SUPERBLOCKS_ENABLED, 4070908800ULL),         // OFF
    MAKE_SPORK_DEF(SPORK_17_QUORUM_DKG_ENABLED, 1756352200),         // ON
    MAKE_SPORK_DEF(SPORK_19_CHAINLOCKS_ENABLED, 1757155900),         // ON
    MAKE_SPORK_DEF(SPORK_21_LOW_LLMQ_PARAMS, 1757019614),            // ON
    MAKE_SPORK_DEF(SPORK_22_SPECIAL_TX_FEE, 4070908800ULL),             // OFF mean chain would take any fee for special tx as valid
    MAKE_SPORK_DEF(SPORK_23_QUORUM_ALL_CONNECTED, 1756352200),       // ON
    MAKE_SPORK_DEF(SPORK_24_PS_MORE_PARTICIPANTS, 4070908800ULL),       // OFF
    MAKE_SPORK_DEF(SPORK_25_QUORUM_POSE, 1756352200),                // ON
};
