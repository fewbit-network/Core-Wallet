...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_2_INSTANTSEND_ENABLED, 1768859491ULL),         // OFF
    MAKE_SPORK_DEF(SPORK_3_INSTANTSEND_BLOCK_FILTERING, 1768859491ULL), // OFF
    MAKE_SPORK_DEF(SPORK_9_SUPERBLOCKS_ENABLED, 4070908800ULL),         // OFF
    MAKE_SPORK_DEF(SPORK_17_QUORUM_DKG_ENABLED, 1762886669ULL),         // ON
    MAKE_SPORK_DEF(SPORK_19_CHAINLOCKS_ENABLED, 1763097347ULL),         // ON
    MAKE_SPORK_DEF(SPORK_21_LOW_LLMQ_PARAMS, 4070908800ULL),            // OFF
    MAKE_SPORK_DEF(SPORK_22_SPECIAL_TX_FEE, 1768859491ULL),             // OFF mean chain would take any fee for special tx as valid
    MAKE_SPORK_DEF(SPORK_23_QUORUM_ALL_CONNECTED, 1762886669ULL),       // ON
    MAKE_SPORK_DEF(SPORK_24_PS_MORE_PARTICIPANTS, 1768859491ULL),       // OFF
