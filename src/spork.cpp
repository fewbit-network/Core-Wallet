...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_2_INSTANTSEND_ENABLED, 1768859491ULL),         // ON
    MAKE_SPORK_DEF(SPORK_3_INSTANTSEND_BLOCK_FILTERING, 1768859491ULL), // ON
    ...
    MAKE_SPORK_DEF(SPORK_22_SPECIAL_TX_FEE, 1768859491ULL),             // ON
    MAKE_SPORK_DEF(SPORK_23_QUORUM_ALL_CONNECTED, 1762886669ULL),       // ON
    MAKE_SPORK_DEF(SPORK_24_PS_MORE_PARTICIPANTS, 1768859491ULL),       // ON
